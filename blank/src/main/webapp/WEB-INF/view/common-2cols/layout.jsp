    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <!-- ヘッダ部 -->
                <div class="col-sm-12">
                    <tiles:insert page="/WEB-INF/view/common-2cols/header.jsp" />
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-2" style="margin-bottom: 15px;">
                    <tiles:insert page="/WEB-INF/view/common-2cols/menu.jsp" />
                </div>
                <!-- メインコンテンツ -->
            ...
            <div class="row">
                ...
                <div class="col-sm-12" style="background-color: #eee;">
                    <tiles:insert page="/WEB-INF/view/common-2cols/footer.jsp" />
                </div>
            </div>
