...
public class OnetimeKeyTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(OnetimeKey.class).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_userAuth() throws Exception {
        jdbcManager.from(OnetimeKey.class).leftOuterJoin(userAuth()).id(1).getSingleResult();
    }
}