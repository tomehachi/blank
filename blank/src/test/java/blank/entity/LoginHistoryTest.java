...
public class LoginHistoryTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(LoginHistory.class).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_userAuth() throws Exception {
        jdbcManager.from(LoginHistory.class).leftOuterJoin(userAuth()).id(1).getSingleResult();
    }
}